...
setcustomshortcut.py "Normale lettergrootte" /usr/local/bin/normal-scale.sh "<Super>-"
setcustomshortcut.py "Dubbele lettergrootte" /usr/local/bin/double-scale.sh "<Super>="
